                        ...
                        <Group position="center" mt="md">
                            ...
                            <div hidden={calendarVisible} style={{width: "20vw"}}>
                                <Prism
                                    language="tsx"
                                    noCopy
                                >{`${window.location.origin}${calendarURL}`}</Prism>
                                ...
                                <Center>
                                    <Button
                                        onClick={() => {
                                            navigator.clipboard.writeText(window.location.origin + calendarURL).then(() => window.location.replace(`webcal://${window.location.host}${calendarURL}`))
                                        }}
