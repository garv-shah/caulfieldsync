                                ...
                                <Center>
                                    <Button
                                        onClick={() => {
                                            ...
                                            const url = `${calendarURL}?alertTime=${alerts ? values.alertTime*60 : 'null'}&shorten=${values.shorten}&events=${!values.events}`
                                            navigator.clipboard.writeText(windowURL + url).then(() => window.location.replace(`webcal://${window.location.host}${url}`))
                                        }}
